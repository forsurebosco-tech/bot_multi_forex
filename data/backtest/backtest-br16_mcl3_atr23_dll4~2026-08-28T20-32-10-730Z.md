...
- **Engine gates active:** sessions (London/NY/overlap), H1 EMA200 trend + chop zone + slope, ADX20 regime, spread ≤2x typical, 4 signals/day, -4% engine day stop, 2-SL breaker, 1 pos/pair, max 3 concurrent, correlation (gold = USD bucket).
...
*Generated 2026-08-28T20:32:10.730Z — engine v1 (analyzePair), conservative fills, no news calendar feed (blackout = empty).*
